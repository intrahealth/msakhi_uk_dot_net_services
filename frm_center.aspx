<%@ Page Language="C#" MasterPageFile="~/PISMasterPage.master" StylesheetTheme="NewTheme" AutoEventWireup="true" CodeFile="frm_center.aspx.cs" EnableEventValidation="false" 
Inherits="frm_center" Title="Sub Center Master" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Width="100%">
                <div style="vertical-align: middle; width: 100%; background-color: White; height: 30px;
                   ...
                   <asp:Label ID="LblModule" runat="server" ForeColor="#000"
                        Width="380px" Height="20px" Font-Bold="True" Font-Names="Arial" Font-Size="20px">Sub Center Master</asp:Label>
                        <asp:Label ID="lbl_Root" runat="server" ForeColor="#000" Font-Size="20px"  CssClass="class"
                        Font-Names="Arial" Font-Bold="True">Login > Masters >Sub Center </asp:Label>
                ...
                <div style="width: 100%" id="divadd">
                    <table style="width: 100%; background-color: #eee;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="vertical-align: top; width: 151px; height: 22px; text-align: left" class="TdData">
                                                    <asp:Label ID="LabelDISTRICT" runat="server" Width="73px" CssClass="labelTitle" Text="CenterCode"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; width: 200px; height: 22px; text-align: left" class="TdData">
                                                    <asp:Label ID="LabelBLOCK" runat="server" style="display:inline-block;width:70px;margin-left: -61%;" CssClass="labelTitle" Text="CenterName"></asp:Label>
                                                </td>
                                            ...
                                            <tr >
                                                ...
                                                <asp:TextBox runat="server" ID="txt_code" Style="width: 45%;" placeholder="center code 4 digit"></asp:TextBox>
                                              
                                                </td>
                                                <td style="vertical-align: top; width: 157px; height: 22px; text-align: left" class="TdData">
                                                 <asp:TextBox runat="server" ID="txtcentername" Style="width: 78%; margin-left: -120px;" placeholder="center Name"></asp:TextBox>
                                                
                                                </td>
                                                <td style="vertical-align: top; height: 22px; text-align: center" class="TdData">
                        <asp:Button ID="btnAdd" OnClick="btnAdd_Click1" runat="server" Text="Add Center" Style="float: right;" CssClass="submit_butt-new"
                        ...
                        BorderColor="Navy">
                                        <asp:GridView ID="GVCenterData" runat="server" Width="100%" CssClass="mGrid" OnSorting="GVCenterData_Sorting"
                                            OnRowCommand="GVCenterData_RowCommand" OnRowDataBound="GVCenterData_RowDataBound"
                                            PageSize="15" DataKeyNames="SubCenterCode,SubCenterID" AutoGenerateColumns="False"
                                            AllowSorting="True" AllowPaging="True" OnPageIndexChanging="GVCenterData_PageIndexChanging"
                                            PagerStyle-CssClass="pgr">
                                            <PagerSettings Position="TopAndBottom"></PagerSettings>
                                            <Columns>
                                                <asp:BoundField DataField="SubCenterCode" HeaderText="Center Code" SortExpression="SubCenterCode" Visible="false">
                                                 <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left"  Width="250px"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="SubCenterID" HeaderText="Center ID" SortExpression="SubCenterID" Visible="True">
                                                 <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left"  Width="250px"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="SubCenterName" HeaderText="Center Name" SortExpression="">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left" Font-Size="13px" Width="350px"></ItemStyle>
                                                </asp:BoundField>
                                                  
                                                <asp:BoundField DataField="SubCenterName_Hindi" HeaderText="Center Name Hindi" SortExpression="">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left" Font-Size="13px" Width="350px"></ItemStyle>
                                                </asp:BoundField>
                                ...
                                <tr>
                                    <td style="vertical-align: top; text-align: left" class="TdData">
                                        <asp:Label ID="Label2" runat="server" CssClass="labelTitle" __designer:wfdid="w6"
                                            Text="Center Name"></asp:Label><span style="color: red">*</span>
                                    </td>
                                    <td style="vertical-align: top; width: 216px; text-align: left" class="TdData">
                       
                                        <asp:TextBox ID="txtCenterNm" TabIndex="2" runat="server" Width="185px" CssClass="shg_selec"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="ErrorMsg"
                                            ...
                                            ControlToValidate="txtCenterNm" ErrorMessage="Enter Center Name!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
<tr>
                                    <td style="vertical-align: top; text-align: left" class="TdData">
                                        <asp:Label ID="Label1" runat="server" CssClass="labelTitle" __designer:wfdid="w6"
                                            Text="Center Name Hindi"></asp:Label><span style="color: red">*</span>
                                    </td>
                                    <td style="vertical-align: top; width: 216px; text-align: left" class="TdData">
                       
                                        <asp:TextBox ID="txtCenterNmhindi" TabIndex="2" runat="server" Width="185px" CssClass="shg_selec"
                                            __designer:wfdid="w7" ValidationGroup="grpBlock" MaxLength="30"></asp:TextBox><br /><br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="ErrorMsg"
                                            __designer:wfdid="w8" ValidationGroup="grpBlock" SetFocusOnError="True" Display="Dynamic"
                                            ControlToValidate="txtCenterNmhindi" ErrorMessage="Enter Center Name in Hindi!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
