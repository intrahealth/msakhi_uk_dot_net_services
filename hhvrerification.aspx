<%@ Page Title="Verification" Language="C#" MasterPageFile="~/PISMasterPage.master" AutoEventWireup="true"
    CodeFile="hhvrerification.aspx.cs" Inherits="hhvrerification" %>
                    ...
                    <asp:Panel ID="Panel5" runat="server" Height="300px" Width="100%" ScrollBars="Vertical"
                        ...
                        <asp:GridView ID="GVanmData" runat="server" Width="100%" CssClass="mGrid" OnSorting="GVanmData_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="subcentercode" HeaderText="Sub Center Code" SortExpression=""
                                    Visible="True">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left" Width="50px"></ItemStyle>
                                </asp:BoundField>
